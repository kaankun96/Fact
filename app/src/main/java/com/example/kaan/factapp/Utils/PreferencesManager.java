...
public abstract class PreferencesManager {
    private static final String defaultPackageName = "packageSettings";
    ...
    protected PreferencesManager(Context targetContext, String preferenceName) {
        Context targetContext1 = targetContext;
        this.preferenceName = preferenceName;
        targetPreferences = targetContext1.getSharedPreferences(preferenceName, Context.MODE_PRIVATE);
    }
